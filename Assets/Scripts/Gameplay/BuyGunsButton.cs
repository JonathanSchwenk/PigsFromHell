...
public class BuyGunsButton : MonoBehaviour
{
    ...
    /*
        Issue, button script/function needs to be in scene for the actual button but the items are attached
        to each buy gun object and there are multiple. Might need parameters
    */
    ...
    private void SetGunsFromSaveDataNorm(int primaryOrSecondary, int i) {
        ...
        */
        ...
        gameManager.activeWeapon = gameManager.currentWeapons[primaryOrSecondary];
    }
